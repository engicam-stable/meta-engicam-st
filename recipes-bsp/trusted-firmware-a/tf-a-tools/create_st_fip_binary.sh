...
echo "CMD> $TOOLS_FIPTOOL create --align 2048 $fiptool_opt $fip_certconf_opt_addons $fip_certconf_opt \\ " | sed "s|--|\\\ \n\t--|g"
...
if [ $DRY_RUN -eq 0 ]; then
    $TOOLS_FIPTOOL create --align 2048 $fiptool_opt  $fip_certconf_opt $fip_certconf_opt_addons $fiptool_output_file || die "FIPTOOL error"
fi
